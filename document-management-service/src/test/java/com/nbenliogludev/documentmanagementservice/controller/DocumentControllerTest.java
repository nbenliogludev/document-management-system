...
class DocumentControllerTest {
        ...
        public void setup() throws Exception {
                ...
                org.mockito.Mockito
                                .when(approvalRegistryGateway
                                                .existsByDocumentId(org.mockito.ArgumentMatchers.any(UUID.class)))
                                .thenReturn(true);
                org.mockito.Mockito
                                .when(approvalRegistryGateway
                                                .countByDocumentId(org.mockito.ArgumentMatchers.any(UUID.class)))
                                .thenReturn(1L);
        }
